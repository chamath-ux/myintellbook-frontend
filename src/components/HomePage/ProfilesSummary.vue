<template>
     <Card :pt="{
            ...
            <template #header>
                <div class="w-100 d-flex justify-content-end p-2 pb-0">
                    <i class="pi pi-times p-1 border rounded-circle bg-secondary text-white" />
                </div>
            </template>
            <template #content>
...
const profileDeatils = computed(() => props.profile);
</script>